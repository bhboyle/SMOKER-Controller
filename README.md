...
This system is not intended to less expensive than other options out in the aftermarket store. In fact with all the hardware testing I did it was notably more expensive than an existing product. but now that it is done I have exactly what I wanted and it is configurable and updatable in ways store bought options could never be. This has been a passion project that is now ready to be tested on my Masterbuilt Gravity smoker.
