I used a Bamblu labs P1S for my prints. I printed the housing on its back and required supports for the saids as well as the bottom of the display side. With out the supports the side tended to lean while being printed.

The template file is to be used to drill mounting holes if necessary.
