 ...
 * Size: 120 px
 * Bpp: 1
 * Opts: --bpp 1 --size 120 --no-compress --stride 1 --align 1 --font arial.ttf --range 9650,9660 --format lvgl -o UpDown120.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1900, .box_w = 83, .box_h = 83, .ofs_x = 18, .ofs_y = 0},
    {.bitmap_index = 862, .adv_w = 1900, .box_w = 83, .box_h = 83, .ofs_x = 18, .ofs_y = -2}
};
